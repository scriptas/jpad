...
export default function Editor() {
    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden bg-background min-h-0">
            ...
            {/* Toolbar: Flex sibling above scroll area for stability */}
            <div className="flex items-center gap-0.5 px-2 py-1.5 border-b-2 border-border bg-surface/95 backdrop-blur-md z-30 overflow-x-auto flex-shrink-0"
            >
                <ToolbarButton
